	...
	<div class="container  clearfix">
		<div class="one-third1 column">
			<ul>
				...
				<li class="active"><a href="teammember.php"><img alt="" src="img/user.png"><span>Team Member</span></a></li>
				<?php 
				$jhjh=$_SESSION['POWER'];
				if($jhjh==1){
				?>
		...
		<div class="two-thirds1 column">
			...
			<a rel="facebox" href="addteammember.php"> Add Team </a>
			<table id="resultTable" data-responsive="table">
				...
				<tbody>
						...
						<td><a rel="facebox" href="editteammember.php?id=<?php echo $row['ctm_id']; ?>"> Edit </a> | <a href="#" id="<?php echo $row['ctm_id']; ?>" class="delbutton" title="Click To Delete">Delete</a></td>
						</tr>
						<?php
							}
						?>
